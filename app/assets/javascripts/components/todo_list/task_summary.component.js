(function() {
  ...
  TaskSummaryController.$inject = ['$rootScope', '$scope', '$http', '$window', 'taskFactory', 'colorFactory'];

  function TaskSummaryController($rootScope, $scope, $http, $window, taskFactory, colorFactory){
    var vm = this;
